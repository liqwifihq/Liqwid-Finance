  ...
  return (
    <section
      style={{
        ...
        alignItems: 'center',
        padding: isMobile ? '40px 20px 50px' : '0px 120px 100px',
        width: '100%',
        maxWidth: '100%',
            ...
            >
              ...
              <div
                style={{
                  ...
                  justifyContent: 'center',
                  alignItems: 'center',
                  padding: '48.03px 59px 48.02px',
                  isolation: 'isolate',
                  position: 'absolute',
                  height: '496.55px',
                  left: '-0.1%',
                  right: '50.1%',
                  top: 'calc(50% - 496.55px/2)',
                  borderRadius: '32px',
                }}
              >
                {/* Image Background */}
